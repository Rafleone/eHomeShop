...
public class ModelShop {
    private String uid, email, name, shopName, phone, deliveryFee, county, state, city, address,
    ...
    public ModelShop(String uid, String email, String name, String shopName, String phone,
                     String deliveryFee, String county, String state, String city, String address,
