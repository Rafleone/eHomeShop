...
import ehomeshop.com.FilterProduct;
import ehomeshop.com.R;
import ehomeshop.com.activities.EditProductActivity;
...
public class AdapterProductSeller extends RecyclerView.Adapter<AdapterProductSeller.HolderProductSeller> implements Filterable {
    ...
    private void detailsBottomSheet(ModelProduct modelProduct) {
        ...
        if (discountAvailable.equals("true")){
            ...
            originalPriceTv.setPaintFlags(originalPriceTv.getPaintFlags() | Paint.STRIKE_THRU_TEXT_FLAG); // add strike through on origina; price
        } else {
            //product is on discount
